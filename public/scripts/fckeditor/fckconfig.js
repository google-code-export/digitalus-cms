...
FCKConfig.ToolbarSets["Default"] = [
	['Source','-','Save','NewPage','Preview','-','Templates', 'PasteWord','-','Print','SpellCheck'],
...
FCKConfig.ToolbarSets["Basic"] = [
	['NewPage','Undo','Redo','Save','-','Bold','Italic','FontFormat', '-','OrderedList','UnorderedList','-','Link','Unlink','-','Table','Image','-','PasteText','PasteWord','-','Source']
] ;
