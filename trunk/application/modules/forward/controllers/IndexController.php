 ...
 * @since       Release 1.10
 */
class Mod_Forward_IndexController extends Digitalus_Controller_Action
{
    /**
    ...
    public function init()
    {
        ...
        $this->view->breadcrumbs = array(
           ...
           $this->view->getTranslation('Forward') => $this->baseUrl . '/mod_forward'
        );
        $this->view->toolbarLinks['Add to my bookmarks'] = $this->baseUrl . '/admin/index/bookmark/url/mod_forward';
    }
